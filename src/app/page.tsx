  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6 text-center">
      <div className="bg-white p-12 md:p-20 rounded-[3rem] shadow-2xl border border-slate-100 max-w-2xl w-full flex flex-col items-center animate-in fade-in zoom-in duration-700">
        <div className="w-20 h-20 bg-primary rounded-3xl flex items-center justify-center text-white mb-8 shadow-lg shadow-primary/20">
        ...
        <a 
          href="tel:9975740444" 
          className="flex items-center gap-4 bg-primary hover:bg-primary/90 text-white px-8 py-4 rounded-2xl font-bold text-xl transition-all hover:scale-105 active:scale-95 shadow-xl shadow-primary/20"
        >
